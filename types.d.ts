...
// Get the previous number (for indexing)
// (2=>1, 1=>0, 0=>never)
...
// Iterate through the unaries and for each previous/current 
// pair, the previous return value should be applicable to the 
// current parameter value. If it doesn't, this function maps 
// to the correct value. When we try to apply the actual type 
// we get a mismatch which is easier to diagnose.
